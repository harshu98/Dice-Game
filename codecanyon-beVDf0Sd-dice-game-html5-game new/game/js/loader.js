...
function initPreload() {
    ...
    manifest = [{ src: 'assets/board.png', id: 'board' },
        ...
        { src: 'assets/credits_panel.png', id: 'creditspanel' },
        { src: 'assets/win_panel.png', id: 'winpanel' },
        { src: 'assets/paid_panel.png', id: 'paidpanel' },

        { src: 'assets/wallet.png', id: 'wallet' },

        { src: 'assets/token_icon.png', id: 'tokenIcon' },

        { src: 'assets/title.png', id: 'Gametitle' },

        { src: 'assets/gameplay_table.png', id: 'backGround' },
